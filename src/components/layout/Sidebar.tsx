...
export const Sidebar = () => {
  ...
  const links = [
    { name: 'Dashboard', href: '/', icon: LayoutDashboard, roles: ['Cashier', 'Supervisor', 'Manager', 'Accountant', 'Director', 'Admin'] },
    ...
    { name: 'Payments', href: '/payments', icon: CreditCard, roles: ['Cashier', 'Supervisor', 'Accountant', 'Director', 'Admin'] },
    { name: 'Expenses', href: '/expenses', icon: FileText, roles: ['Cashier', 'Supervisor', 'Manager', 'Accountant', 'Director', 'Admin'] },
    { name: 'Inventory', href: '/inventory', icon: Package, roles: ['Cashier', 'Supervisor', 'Manager', 'Accountant', 'Director', 'Admin'] },
    { name: 'Clients', href: '/clients', icon: UserCheck, roles: ['Cashier', 'Supervisor', 'Manager', 'Accountant', 'Director', 'Admin'] },
    { name: 'Staff', href: '/staff', icon: Users, roles: ['Cashier', 'Supervisor', 'Manager', 'Accountant', 'Director', 'Admin'] },
    { name: 'Branches', href: '/branches', icon: MapPin, roles: ['Cashier', 'Supervisor', 'Manager', 'Accountant', 'Director', 'Admin'] },
    { name: 'Suppliers', href: '/suppliers', icon: Truck, roles: ['Supervisor', 'Manager', 'Accountant', 'Director', 'Admin'] },
